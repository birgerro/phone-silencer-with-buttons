...
package birger.backports_api10;
...
public class NumberPicker extends LinearLayout {
	...
	private boolean wrap_around = true; // Birger's improvement
    ...
    public void setRange(int start, int end) {
        setRange(start, end, mDisplayedValues);
    }
    ...
    protected void changeCurrent(int current) {
        ...
        //    current = mEnd;
        //}
    	// Birgers improvement: only wrap if wrap around is enable
        if (current > mEnd) {
        	if (wrap_around){
        		current = mStart;
        	} else {
    ...
    public void setWrapSelectorWheel(boolean new_value) {
    	// not easily implemented...
    	// Birger's improvement:
    	wrap_around = new_value;
    }
